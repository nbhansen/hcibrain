...
from hci_extractor.core.events import get_event_bus, RetryAttempted, RetryExhausted, RetrySucceeded
...
class TestRetryHandler:
    ...
    async def test_successful_operation_no_retry(self, simple_policy):
        ...
        handler = RetryHandler(policy=simple_policy, operation_name="test_op")
    ...
    @pytest.mark.asyncio
    async def test_operation_succeeds_after_retries(self, simple_policy, event_collector):
        """Test operation that fails then succeeds."""
        handler = RetryHandler(policy=simple_policy, operation_name="test_retry")
    ...
    async def test_all_retries_exhausted(self, simple_policy, event_collector):
        ...
        handler = RetryHandler(policy=simple_policy, operation_name="always_fails")
    ...
    async def test_non_retryable_exception(self, simple_policy):
        ...
        handler = RetryHandler(policy=policy, operation_name="non_retryable")
    ...
    async def test_rate_limit_error_with_retry_after(self, simple_policy):
        ...
        handler = RetryHandler(policy=simple_policy, operation_name="rate_limited")
    ...
    async def test_timeout_handling(self):
        ...
        handler = RetryHandler(policy=policy, operation_name="timeout_test")
    ...
    def test_synchronous_retry(self, simple_policy):
        ...
        handler = RetryHandler(policy=simple_policy, operation_name="sync_test")
...
class TestRetryStrategies:
    ...
    def test_exponential_backoff_calculation(self):
        ...
        handler = RetryHandler(policy=policy, operation_name="exponential_test")
    ...
    def test_linear_backoff_calculation(self):
        ...
        handler = RetryHandler(policy=policy, operation_name="linear_test")
    ...
    def test_fixed_delay_calculation(self):
        ...
        handler = RetryHandler(policy=policy, operation_name="fixed_test")
    ...
    def test_max_delay_limit_calculation(self):
        ...
        handler = RetryHandler(policy=policy, operation_name="max_delay_test")
...
class TestEventIntegration:
    ...
    async def test_event_details(self, event_collector):
        ...
        handler = RetryHandler(policy=policy, operation_name="detailed_events")
