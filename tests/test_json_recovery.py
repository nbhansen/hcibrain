...
class TestBasicRecovery:
    ...
    def test_valid_json_passes_through(self):
        ...
        assert result.recovered_data == {"elements": [{"text": "test", "type": "finding"}]}
...
class TestArrayCompletionRecovery:
    ...
    def test_incomplete_elements_array(self):
        ...
        malformed = '{"elements": [{"text": "test", "type": "finding"}, {"text": "incomp'
...
class TestCombinedStrategies:
    ...
    def test_all_strategies(self):
        ...
        assert result.success
        assert result.strategy_used in ["array_completion", "truncation", "trailing_content"]
    ...
    def test_strategy_order_matters(self):
        ...
        options1 = JsonRecoveryOptions(strategies=["trailing_content", "array_completion"])
        result1 = recover_json(malformed, options1)
        assert result1.strategy_used == "trailing_content"
        
        # Reverse order
        options2 = JsonRecoveryOptions(strategies=["array_completion", "trailing_content"])
