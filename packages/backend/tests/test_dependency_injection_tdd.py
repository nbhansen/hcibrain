...
class TestDependencyInjectionContainer:
    ...
    def test_di_container_provider_dependencies_injected(self, sample_config):
        ...
        assert hasattr(provider, '_markup_prompt_loader') or hasattr(provider, 'markup_prompt_loader')
    ...
    def test_di_container_prompt_loader_configuration(self, mock_prompt_loader_class, sample_config):
