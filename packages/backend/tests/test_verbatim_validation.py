...
class TestVerbatimAccuracy:
    ...
    def test_exact_text_match_passes(self):
        ...
        assert (
            validated[0].text
            == "Users completed tasks 25% faster with the new interface design"
        )
...
class TestVerbatimEdgeCases:
    ...
    def test_special_characters_preserved(self):
        ...
        source_text = (
            "Performance improved by ~25% (β = 0.42, p < 0.001, CI₉₅ = [0.15, 0.35])."
        )
    ...
    def test_mathematical_notation(self):
        ...
        source_text = (
            "The algorithm complexity is O(n²) with space requirements of Θ(n log n)."
        )
...
class TestVerbatimPerformance:
    ...
    def test_large_document_validation(self):
        ...
        section_text = (
            "This is a test sentence that appears in the academic paper. " * 100
        )
