    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                ...
                "plain_language_summary": "Researchers developed a new way to help computers understand human speech better. They used advanced artificial intelligence techniques called deep neural networks with special attention features. Their approach made speech recognition 15% more accurate than previous methods.",
