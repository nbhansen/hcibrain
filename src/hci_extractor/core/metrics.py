...
class MetricsCollector:
    ...
    def get_extraction_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            "total_elements": sum(m.elements_extracted for m in self._extraction_metrics),
            "average_duration": sum(m.duration_seconds for m in self._extraction_metrics) / total,
            "total_characters": sum(m.characters_extracted for m in self._extraction_metrics),
    ...
    def _group_errors(self, metrics: List) -> Dict[str, int]:
