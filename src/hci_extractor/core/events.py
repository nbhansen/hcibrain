...
from typing import Dict, List, Protocol, Type, Optional, Any
...
class LoggingEventHandler:
    ...
    def handle(self, event: DomainEvent) -> None:
        self.logger.debug(
            ...
            f"[{event.event_id}] at {event.occurred_at}"
        )
...
class MetricsEventHandler:
    ...
    def handle(self, event: DomainEvent) -> None:
        ...
        if isinstance(event, (ExtractionCompleted, SectionProcessingCompleted)):
